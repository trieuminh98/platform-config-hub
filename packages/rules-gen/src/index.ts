...
const spinner = ora({
  text: "Because automation should look good.",
...
(async () => {
  ...
  try {
    ...
    summary = `Generated: ${outTargets.join(", ")} for ${kindTargets.join(", ")}`;
  } finally {
    if (spinner.isSpinning) spinner.text = "Cleaning up temporary files...";
